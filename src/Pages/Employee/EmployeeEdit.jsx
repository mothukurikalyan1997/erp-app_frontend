...
const EmployeeEdit = () => {
    ...
    const handleChange = (e) => {
          ...
          const handleSubmit = (e) => {
            e.preventDefault();
            console.log(emp)
            axios.put(`${API_URL}/emp/employeeedit/${id}`,{emp},{
                headers:{
    ...
    useEffect(()=>{
        const token = localStorage.getItem('token');
        axios.get(`${API_URL}/emp/employeeedit/${id}`,{
          headers:{
            'Authorization': `Bearer ${token}`,
            'company_id': company_id,
            'role': role,
      ...
      <div  className='actual-container'>
        ...
        <p style={{backgroundColor:'#3b7483',padding:'5px',display:'flex',color:'white',fontWeight:'bold',borderRadius:'10px',paddingLeft:'15px',justifyContent:'flex-start',alignContent:'flex-start'}}>Personal Details</p>
            <div style={{width:'600px', display:'flex', alignItems:'center'}}>
                <label htmlFor="" style={{width:'200px'}}>EMP Status</label>
            ...
            <div style={{width:'600px', display:'flex', alignItems:'center'}}>
                ...
                <input type="date" name="eidexp" value={emp.eidexp && emp.eidexp.split('T')[0]} onChange={handleChange}  />
            </div>
            <div style={{width:'600px', display:'flex', alignItems:'center'}}>
            ...
            <div style={{width:'600px', display:'flex', alignItems:'center'}}>
                ...
                <input type="date" name="ppexp" value={emp.ppexp && emp.ppexp.split('T')[0]} onChange={handleChange}  />
            </div>
            <div style={{width:'600px', display:'flex', alignItems:'center'}}>
            ...
            <div style={{width:'600px', display:'flex', alignItems:'center'}}>
                ...
                <input type="date" name="joindate" value={emp.joindate && emp.joindate.split('T')[0]} onChange={handleChange}  />
            </div>
            <div style={{width:'600px', display:'flex', alignItems:'center'}}>
            ...
            <div style={{width:'600px', display:'flex', alignItems:'center'}}>
                ...
                <input type="date" name="licenseexp" value={emp.licenseexp && emp.licenseexp.split('T')[0]} onChange={handleChange}  />
            </div>
